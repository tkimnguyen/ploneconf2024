...
site_id = "Plone"
payload = {
    "title": "Plone Conference Training",
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-ploneconf2024:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-ploneconf2024:initial")
        transaction.commit()
    app._p_jar.sync()
